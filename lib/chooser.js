...
exports["default"] = _react2["default"].createClass({
    ...
    getFilteredOptionList: function getFilteredOptionList(input, limit, choice) {
        ...
        var results = _underscore2["default"].map(limitItems, function (c) {
            return { value: c.id, label: c.label, disabled: _underscore2["default"].has(c, "disabled") ? c.disabled : false };
        });

        var limitItemsContainsChoice = false;
        _underscore2["default"].each(results, function (item) {
    ...
    render: function render() {
        ...
        if (searchable) {
            var options = this.getFilteredOptionList(null, this.props.limit, choice);
