...
var _rcCssTransitionGroup = require("rc-css-transition-group");

var _rcCssTransitionGroup2 = _interopRequireDefault(_rcCssTransitionGroup);
    ...
    render: function render() {
        ...
        var itemList = _underscore2["default"].map(this.props.items, function (item, index) {
            ...
            if (addMinus && !itemMinusHide) {
                minus = _react2["default"].createElement("i", { id: index, key: minusActionKey, className: "glyphicon glyphicon-minus esnet-forms-small-action-icon",
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    _rcCssTransitionGroup2["default"],
