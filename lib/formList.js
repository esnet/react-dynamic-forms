    ...
    return (function(_React$Component) {
        ...
        function HOC(props) {
            ...
            var _this = _possibleConstructorReturn(
                this,
                (HOC.__proto__ || Object.getPrototypeOf(HOC)).call(this, props)
            );
        ...
        _createClass(HOC, [
            ...
            },
            {
                ...
                value: function handleMissingCountChange(i, missingCount) {
                    ...
                    totalMissingCount = _underscore2.default.reduce(
                        missingList,
                        function(memo, num) {
                            return memo + num;
                        },
            ...
            },
            {
                ...
                value: function handleErrorCountChange(i, errorCount) {
                    ...
                    totalErrorCount = _underscore2.default.reduce(
                        errorList,
                        function(memo, num) {
                            return memo + num;
                        },
            ...
            },
            {
                ...
                value: function render() {
                    ...
                    this.props.value.forEach(function(item, index) {
                        var _item$key = item.key, key = _item$key === undefined ? index : _item$key;
                        ...
                        var props = {
                            ...
                            onMissingCountChange: function onMissingCountChange(
                                name,
                                missingCount
                            ) {
                    ...
                    var plusElement = (errors || missing) && hideEditRemove
                    ...
                    var _props = this.props,
                        ...
                        canRemoveItems = _props$canRemoveItems === undefined
                            ? true
                            : _props$canRemoveItems;
