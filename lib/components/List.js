            ...
            value: function render() {
                ...
                var itemList = _underscore2.default.map(this.props.items, function(item, index) {
                    ...
                    if (_this2.props.hideEditRemove) {
                        isEditable = _this2.props.hideEditRemove &&
                            index === _this2.props.items.length - 1;
                    } else {
                        isEditable = true;
                    }
                    if (isEditable) {
                        if (addMinus && !itemMinusHide) {
                            ...
                            minus = _react2.default.createElement("div", {
