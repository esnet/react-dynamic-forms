...
exports.default = {
  /* FormMixin */
  propTypes: { schema: _react2.default.PropTypes.object.isRequired },
  getInitialState: function getInitialState() {
    ...
    _underscore2.default.each(attrs, function (attr, attrName) {
      ...
      if (initialValues) {
        ...
        values[attrName] = {
          value: defaultValue,
          initialValue: (0, _deepcopy2.default)(defaultValue)
        };
      }
    });
  ...
  /**
     ...
     */
  updateState /* why */: function updateState() {
    var _this2 = this;
