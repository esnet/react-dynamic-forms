...
var TagsEdit = function (_React$Component) {
  ...
  function TagsEdit() {
    ...
    return _possibleConstructorReturn(this, (TagsEdit.__proto__ || Object.getPrototypeOf(TagsEdit)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      if (this.props.edit) {
        var _ret = function () {
          ...
          _this3.props.tagList.forEach(function (tag, i) {
        ...
        var _ret2 = function () {
          ...
          return {
            v: _react2.default.createElement(
              "div",
              null,
              _this3.props.value.map(function (tag, i) {
