...
var TextEdit = (function(_React$Component) {
    ...
    function TextEdit(props) {
        ...
        var _this = _possibleConstructorReturn(
            this,
            (TextEdit.__proto__ || Object.getPrototypeOf(TextEdit)).call(this, props)
        );

        _this.state = { touched: false };
        return _this;
    }
    ...
    _createClass(TextEdit, [
        ...
        },
        {
            ...
            value: function handleChange() {
                ...
                var _getError3 = this.getError(value), validationError = _getError3.validationError;
            ...
            value: function render() {
                ...
                if (this.props.edit) {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement("div", { className: helpClassName }, msg)
                    );
                } else {
                    ...
                    if (!view) {
                        return _react2.default.createElement("div", { style: _style }, text);
                    } else {
                        return _react2.default.createElement("div", { style: _style }, view(text));
                    }
                }
            }
        }
