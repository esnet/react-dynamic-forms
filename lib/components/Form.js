...
var Form = (function(_React$Component) {
    ...
    function Form(props) {
        ...
        _this.state = { missingCounts: {}, errorCounts: {}, selection: null };
        return _this;
    }
    /**
                    ...
                    _underscore2.default.defer(function() {
                        ...
                        if (_this3._pendingMissing) {
                            ...
                            if (_this3.props.onMissingCountChange) {
                                _this3.props.onMissingCountChange(
                                    _this3.props.name,
                                    missingCount,
                                    missingFields
                                );
                        ...
                        if (_this3._pendingErrors) {
                            ...
                            if (_this3.props.onErrorCountChange) {
                                _this3.props.onErrorCountChange(
                                    _this3.props.name,
                                    errorCount,
                                    errorFields
                                );
        ...
        */
        ...
        },
        {
            ...
            value: function handleErrorCountChange(fieldName, errorCount) {
                ...
                (0, _deepcopy2.default)(this.state.errorCounts) || {};
        ...
        },
        {
            ...
            value: function handleMissingCountChange(fieldName, missingCount) {
                ...
                (0, _deepcopy2.default)(this.state.missingCounts) || {};
                ...
                if (this.props.visible) {
                    _underscore2.default.each(formFields, function(field, fieldName) {
                        ...
                        if (_underscore2.default.isArray(_this4.props.visible)) {
                            makeHidden = !(_underscore2.default.intersection(
                                tags,
                                _this4.props.visible
                            ).length > 0 || _underscore2.default.contains(tags, "all"));
                        } else {
                            makeHidden = !(_underscore2.default.contains(
                                tags,
                                _this4.props.visible
                            ) || _underscore2.default.contains(tags, "all"));
                        }
                        if (makeHidden) {
                        ...
                        if (typeof child.props.children !== "string") {
                            if (_underscore2.default.has(child.props, "field")) {
                                ...
                                props = _extends(
                                    {},
                                    props,
                                    _this5.getFieldProps(formState, fieldName)
                                );
                            }
        ...
        */
        },
        {
            ...
            value: function shouldComponentUpdate(nextProps, nextState) {
                var update = nextProps.value !== this.props.value ||
