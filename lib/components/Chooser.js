...
var Chooser = (function(_React$Component) {
    ...
    function Chooser() {
        ...
        return _possibleConstructorReturn(
            this,
            (Chooser.__proto__ || Object.getPrototypeOf(Chooser)).apply(this, arguments)
        );
    }
        ...
        },
        {
            ...
            value: function componentDidMount() {
                var missing = this.props.required &&
                    !this.props.disabled &&
                    (_underscore2.default.isNull(this.props.value) ||
                        _underscore2.default.isUndefined(this.props.value) ||
                        this.props.value === "");
        ...
        },
        {
            ...
            value: function componentWillReceiveProps(nextProps) {
                if (
                    ...
                    var missing = this.props.required &&
                        !this.props.disabled &&
                        (_underscore2.default.isNull(nextProps.value) ||
                            _underscore2.default.isUndefined(nextProps.value) ||
                            nextProps.value === "");
                    var missingCount = missing ? 1 : 0;
        ...
        },
        {
            ...
            value: function render() {
                ...
                if (this.props.edit) {
                    ...
                    if (!view) {
                        return _react2.default.createElement("div", { style: style }, text);
                    } else {
                        return _react2.default.createElement(
                            "div",
                            { style: viewStyle },
