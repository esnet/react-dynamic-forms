...
var Chooser = function (_React$Component) {
  ...
  _createClass(Chooser, [{
    ...
    value: function isMissing() {
      return this.props.required && !this.props.disabled && this.isEmpty(this.state.value);
    }
  }, {
    key: "generateKey",
    value: function generateKey(choice, choiceList) {
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.state.value !== nextProps.value) {
        var key = this.generateKey(nextProps.value, this.props.choiceList);
        this.setState({
          key: key,
    ...
    value: function getOptionList() {
      ...
      return _underscore2.default.map(this.props.choiceList, function (c) {
        var disabled = false;
        var isDisabled = _underscore2.default.has(c, "disabled") && c.disabled === true;
        if (_underscore2.default.contains(_this2.props.disableList, c.id) || isDisabled) {
          disabled = true;
        }
    ...
    value: function getCurrentChoice() {
      ...
      var choiceItem = _underscore2.default.find(this.props.choiceList, function (item) {
        return item.id === _this3.state.value;
      });
    ...
    value: function getCurrentChoiceLabel() {
      ...
      var choiceItem = _underscore2.default.find(this.props.choiceList, function (item) {
        return item.id === _this4.state.value;
      });
