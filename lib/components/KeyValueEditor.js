...
var CreationState = { OFF: "OFF", PICK_KEYNAME: "PICK_KEYNAME" }; /**
...
var KeyValueListEditor = _react2.default.createClass({
  ...
  createItem: function createItem(data) {
    ...
    return { keyName: keyName, value: value, valueError: false, validationRule: null };
  },
  ...
  plusUI: function plusUI() {
    ...
    switch (this.state.createState) {
      ...
      case CreationState.PICK_KEYNAME:
        var doneButtonElement = void 0;
        var cancelButtonElement = void 0;
  ...
  renderItem: function renderItem(item) {
    var style = { paddingLeft: 12, color: "#A6A6A6" };
