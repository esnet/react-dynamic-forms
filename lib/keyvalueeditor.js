...
var _formmixin = require("./formmixin");
...
var CreationState = (0, _reactLibKeyMirror2["default"])({
    OFF: null,
    PICK_KEYNAME: null
});
...
var KeyValueListEditor = _react2["default"].createClass({
    ...
    transitionTo: function transitionTo(newState) {
        ...
        return function (e) {
            var oldState = _this.state.createState;
    ...
    plusUI: function plusUI() {
        var ui = undefined;
        var keyValueChoice = _underscore2["default"].map(this.props.constraints, function (value, keyname) {
            return {
                "id": value["keyname"],
                "label": value["keyname"]
            };
                        ...
                        _react2["default"].createElement(
                            ...
                            _react2["default"].createElement(
                                ...
                                _react2["default"].createElement(
                                    "td",
                                    null,
                                    _react2["default"].createElement(_chooser2["default"], { attr: "keyName",
                                        initialChoice: null,
                            ...
                            _react2["default"].createElement(
                                ...
                                _react2["default"].createElement(
                                    "td",
                                    null,
                                    _react2["default"].createElement(_textedit2["default"], { attr: "value", rules: this.state.validationRule, onErrorCountChange: this.handleDialogValueError,
...
exports["default"] = _react2["default"].createClass({
    ...
    render: function render() {
        ...
        return _react2["default"].createElement(KeyValueListEditor, { keyValues: keyValueList,
