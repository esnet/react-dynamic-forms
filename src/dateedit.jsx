...
export default React.createClass({
    ...
    componentWillReceiveProps(nextProps) {
        const previousValue =
            this.state.initialValue ? this.state.initialValue.getTime() : null;
        const nextValue =
            nextProps.initialValue ? nextProps.initialValue.getTime() : null;
    ...
    render() {
        ...
        if (this.state.error ||
           (this.props.showRequired && this.isMissing(this.state.value))) {
