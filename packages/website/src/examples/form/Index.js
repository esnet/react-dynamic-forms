...
const description = `
This shows a simple contact form that demostrates most of the low level controls
you can use in the forms library. In this form the schema and values of the form
are loaded at some future time (just using setTimeout in this demo), such as if
they were read from a REST API.

The form shows two modes: full form editing and inline editing.

The form starts off in full edit mode. If you "Save" the form, it will show it in
the inline editing mode. This mode would be used like a view, only the user can make
single line changes to the values by hovering over the item and clicking the pencil
icon. To get back to the full form editing mode you press the "Edit" button.

Randomly generated by pressing the "I feel lucky" button.

Under the action buttons is the data the user code sees (i.e. the immutable
map) and the currently states: missing and errors. These two values are reported
continuously by the form and can be used to block user submission.
`;
            ...
            <div>
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <div style={{ marginBottom: 20 }}>{markdownView(description)}</div>
                    </div>
                </div>
                <hr />
                <div className="row">
